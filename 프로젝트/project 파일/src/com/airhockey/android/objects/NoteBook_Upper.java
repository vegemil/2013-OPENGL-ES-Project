...
public class NoteBook_Upper {
    ...
    public NoteBook_Upper(float width, float height, float thickness)
    {
        GeneratedData generatedData = ObjectBuilder.createNotebookUpper(new Point(0f, 0f, 0f), width, height, thickness);
